        ...
        while True:
            ...
            if user_1 == 1:
                ...
                if len(dados) == 0:
                    ...
                    doc.add_heading('Controle de entrada e saída', 0)  # Adiciona Título a tabela

                    # data contém as informações que serão salvas na tabela dentro do arquivo

                    table = doc.add_table(rows=1, cols=4,
                                          style=('Colorful List'))  # determina o número e linhas e colunas
                    titulo_celula = table.rows[
                        0].cells  # armazena as celulas da linha 0 da tabela (corresponde ao título das células)
                    titulo_celula[0].text = 'Nome'  # define o título da célula dentro da tabela
                    titulo_celula[1].text = 'Placa'  # define o título da célula dentro da tabela
                    titulo_celula[2].text = 'Hora de Entrada'
                    titulo_celula[3].text = 'Hora de saída'

                    for nome,placa, horae, horas in dados:  # desta linha para baixo, preenche as linhas da tabela com os dados em data.
                    ...
                    doc.save('InserirNomeDoArquivo.docx')
