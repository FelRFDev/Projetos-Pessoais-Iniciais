...
def EnviaEmail(nome,destinatario,lista:list):
    ...
    try:
        ...
        for dados in lista:
            body = f"\nOlá {nome}, segue abaixo os seus dados para acesso. Data de Envio:{dataAtualN}!\n\n" \
...
while True:
    visitante = criaMenu('ÁREA DE ACESSO',['Cadastrar','Fazer login','Recuperar Acesso', 'Alterar Senha','Sair'])
    if visitante == 1:
                            ...
                            try:
                                ...
                                while True:
                                    ...
                                    try:
                                        ...
                                        #BLOCO PARA INSERIR O PROGRAMA DESEJADO ==============
        ...
        for usuarios in users:
            if nome in usuarios:
                EnviaEmail(usuarios[0],usuarios[1],users)
        ...
        for usuarios in users:
            if nome in usuarios:
                while True:
                    ...
                    if novaSenha != usuarios[2]:
                        usuarios[2] = novaSenha
                        ...
                        print('ERRO, A NOVA SENHA É IGUAL A SENHA ANTERIOR!')
                        continue
    elif visitante == 5:
        print('SAINDO...')
        sleep(1.8)
