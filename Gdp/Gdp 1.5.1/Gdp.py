...
print(f'{cores["azul"]}                      Bem vindo ao G.D.P  1.0 >>[GESTÃO DE PORTARIA]<<                                {cores["semcor"]}')
print(f'{cores["azul"]}     Feito por: Felipe Rodrigues Fonseca {cores["semcor"]} /{cores["azul"]} contato:  {cores["vermelho"]} {cores["azul"]}comunidadehawks@gmail.com / {cores["azul"]}(55) 99724-6397 {cores["semcor"]}')
                        ...
                        while True:
                            try:
                                ...
                                # Códigos para EDITAR chaves
                                    ...
                                    print(f'{cores["amarelo"]}{key} {cores["verde"]}  >>[CHAVES CADASTRADAS ATÉ O MOMENTO]<< {cores["semcor"]}')
                                    #iniciando estrutura das tabelas para chaves
                                    tabela_chaves = PrettyTable()
                                    with open('chaves.txt','r') as BancoChaves:
                                        ...
                                        with open('nums.txt','r') as BancoNums:
                                            ...
                                            tabela_chaves.add_column(f'{cores["verde claro"]}Chave{cores["semcor"]}', dados, align='c')
                                            tabela_chaves.add_column(f'{cores["verde claro"]}Número{cores["semcor"]}', dadosnum, align='c')
                                            tabela_chaves.set_style(DOUBLE_BORDER)
                                            print(tabela_chaves)
                        ...
                        while True:
                            try:
                                ...
                                # CÓDIGOS PARA EDITAR RAMAIS
                                    ...
                                    print(f'{cores["azul"]}{telefone}{cores["verde"]}  >>[RAMAIS CADASTRADOS ATÉ O MOMENTO]<<  {cores["semcor"]}')

                                    #inicio da estrutura de tabelas para ramal
                                    tabela_ramal = PrettyTable()
                                    with open('NomeRamal.txt', 'r') as BancoRamais:
                                        dados = BancoRamais.readlines()
                                        with open('NumRamal.txt', 'r') as BancoNums:
                                            dadosnum = BancoNums.readlines()
                                            tabela_ramal.add_column(f'{cores["verde claro"]}Setor{cores["semcor"]}', dados, align='c')
                                            tabela_ramal.add_column(f'{cores["verde claro"]}Número do Ramal{cores["semcor"]}', dadosnum, align='c')
                                            tabela_ramal.set_style(DOUBLE_BORDER)
                                            print(tabela_ramal)
                        ...
                        while True:
                            try:
                                ...
                                #INICIO DA ESTRUTURA DE ADICIONAR TAREFAS
                                    ...
                                    print(f'{cores["amarelo"]}{book} {cores["azul"]} >>[TAREFAS CADASTRADAS ATÉ O MOMENTO]<< {cores["semcor"]}')

                                    #inicio da estrutura de tabelas para a lista de afazeres
                                    tabela_afazeres = PrettyTable()
                                    with open('Afazeres.txt', 'r') as afadados:
                                        dados = afadados.readlines()
                                        for tarefa in dados:
                                            temp1.append(tarefa.strip())
                                        tabela_afazeres.add_column(f'{cores["verde claro"]}CÓDIGO{cores["semcor"]}', [temp1.index(i)+1 for i in temp1], align='c')
                                        tabela_afazeres.add_column(f'{cores["verde claro"]}ATIVIDADE{cores["semcor"]}', temp1, align='c')
                                        tabela_afazeres.set_style(DOUBLE_BORDER)
                                        print(tabela_afazeres)
                                    print()
                        ...
                        while True:
                            try:
                                ...
                                if escolha == 1:
                                    ...
                                    print(f'{cores["azul"]}CONSULTA DE ALTERAÇÕES{cores["semcor"]}')
                                    temp3.clear()


                                    print(f'{cores["vermelho"]}{alteracoes} {cores["azul"]}>>>ALTERAÇÕES CADASTRADAS ATÉ O MOMENTO{cores["semcor"]}')
                                    tabela_alteracoes = PrettyTable()
                                    ...
                                    if len(temp3) == 0:
                                        ...
                                        tabela_alteracoes.add_column(f'{cores["verde claro"]}CÓDIGO{cores["semcor"]}', [temp3.index(i)+1 for i in temp3],align='c')
                                        tabela_alteracoes.add_column(f'{cores["verde claro"]}ALTERAÇÃO / DATA DO OCORRIDO / HORÁRIO {cores["semcor"]}', temp3, align='c')
                                        tabela_alteracoes.set_style(DOUBLE_BORDER)
                                        print(tabela_alteracoes)
                                        input('PRESSIONE ENTER PARA VOLTAR AO MENU')
